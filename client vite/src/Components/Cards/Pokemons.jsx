...
//     <div className={styles.cardContainer}>
//       <div className={styles.cardCont}>
//         {/* Mapeo todos los pokemons que recibo y por cada pokemon renderizo una Card pasandole los datos */}
//         {allPokemons?.map((pokemon) => (
//           <Pokemon key={pokemon.id} id={pokemon.id} name={pokemon.name} image={pokemon.image} types={pokemon.types} />
//         ))}
//       </div>
//     </div>
//   );
